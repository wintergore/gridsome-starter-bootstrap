<template>
  <Layout>
    ...
    <template v-slot:main>
      ...
      <p>
        The easiest way to get started quick is to use the Forestry button below, which will create a Github repository for you,
        clone this starter repo and import all data to the CMS. After that is complete, you can just go to
      ...
      <p>Use the following build config for Netlify</p>

      <p>
        Build command:
        <code>gridsome build</code>
      </p>
      <p>
        Publish directory:
        <code>dist</code>
      ...
      <ol>
        <li>
          <code>gridsome create my-gridsome-site https://github.com/LokeCarlsson/gridsome-starter-bootstrap.git</code>
        </li>

        <li>
          <code>cd my-gridsome-site</code> to open folder
        </li>
...
query Pages{
   pages(path: "/page/home"){
    heroTitle
    heroSubTitle
    heroImage (width: 1920, height: 800, quality: 90)
  }
}
</page-query>
